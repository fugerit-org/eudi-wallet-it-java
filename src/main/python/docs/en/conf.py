...
# -- PROJECT Variables ----------------------------------------------------
settings_project_name = "Italian EUDI Java Demo implementation"
# settings_copyright_copyleft = 'Dipartimento per la Trasformazione Digitale'
settings_editor_name = 'Matteo Franci'
settings_doc_version = 'version: latest'
settings_doc_release = 'version: latest'
settings_basename = 'eudi-wallet-it-java'
settings_file_name = 'eudi-wallet-it-java'
